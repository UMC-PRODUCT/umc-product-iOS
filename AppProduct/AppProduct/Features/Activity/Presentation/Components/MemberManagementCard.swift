...
#Preview(traits: .sizeThatFitsLayout) {
    VStack {
        ...
        MemberManagementCard(memberManagementItem: MemberManagementItem(profile: nil, name: "이예지", generation: "9기", position: "Part Leader", part: .front(type: .ios), penalty: 1.0, badge: false, managementTeam: .campusPartLeader))
